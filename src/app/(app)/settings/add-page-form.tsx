    ...
    <>
      <form ref={formRef} action={action} className="flex flex-col gap-2.5 sm:flex-row">
        ...
        <input
          ...
          className="rounded-lg border border-white/15 bg-white/[0.05] px-4 py-2.5 text-white outline-none transition placeholder:text-zinc-500 focus:border-[#e3b341] disabled:opacity-50 sm:w-44"
        />
        <button
