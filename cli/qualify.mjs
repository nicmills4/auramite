...
//
// Usage:
//   node cli/qualify.mjs <list.csv> [--min-visits 50000] [--min-us 0.4] [--concurrency 3] [--limit N]
//
...
if (!file) { console.error('Usage: node cli/qualify.mjs <list.csv> [--min-visits N] [--min-us F] [--concurrency K] [--limit N]'); process.exit(1); }
...
console.log(`Next: node cli/batch.mjs qualified.csv   (scans + scores only the survivors)`);
