...
async function sendEmail({ to, subject, body, redirectTo }) {
 ...
 */
export async function sendOrgReport({ to, pages, ranAt, redirectTo }) {
  ...
  L.push(`Manage your monitoring: ${process.env.NEXT_PUBLIC_BASE_URL || 'https://auramite.io'}/settings`);
